...
// Create the service wrapper
    conversation = watson.conversation({
        ...
        , username: "af8fafe3-8902-4fa3-afd2-cbd970a83db6" // Replace <username>, including "<" and ">"
        , password: "sxREJPzeZNOm" // Replace <password>, including "<" and ">"
        , version_date: '2019-01-09'
        , version: 'v1'
    });
    // check if the workspace ID is specified in the environment
    conversationWorkspace = "ac4c3f79-3d5b-46b0-9017-e78524fe941d"; // Replace <workspace_id>, including "<" and ">"
